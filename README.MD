...
### Week 8 ###
1. Checkout wta-branch-week8 
2. Centralized error handling 
  a. In server.js lines 17 -23
3. Asynchronouse error handling using try/catch block
4. Custom Error Handling - installed responser library
 *** npm install responser ***


 ### Week 9 ###
1. Checkout wta-branch-week9
2. Install helmet.js
  *** npm install helmet ***
3. Code implementation is in server.js
4. Test in Postman http://localhost:3000/
  a. Use Google OAuth to access the url
  b. Send a GET request
5.  Vefiry response header if it contains policies comming from helmet.js 


 ### Week 10 ###
1. Checkout wta-branch-week10
2. Install jest
  *** npm install --save-dev jest ***
3. Create a js file to be tested
  *** example addition.js ***
4. Create a js test file
  *** example addition.test.js ***
5. Add the following section in package.json
{
  "scripts": {
    "test": "jest"
  }
}
6. Run *** npm test *** to verify the output
### Integration Testing ###
7. Install supertest
  *** npm install --save-dev supertest ***
8. Follow the structure of newly created folders and files in this branch
9. Run *** npm test *** to verify the output
